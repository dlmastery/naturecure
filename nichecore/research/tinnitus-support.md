...
>
> **Red flag — sudden one-sided hearing loss with new tinnitus (72-hour clock).** If your tinnitus started in the last 72 hours **and** you also notice sudden one-sided hearing loss or muffled hearing in that ear, this is **sudden sensorineural hearing loss (SSHL)** — an otolaryngology emergency with a **14-day treatment window**. Oral prednisone (60 mg/day × 10-14 days) or intratympanic dexamethasone started inside 14 days dramatically improves the chance of recovery; delayed treatment is associated with much worse hearing recovery. **Same-day escalation path** depends on your country: (a) **UK / EU / AU / IN — book an audiologist same-day** (most systems route SSHL through audiology first; pure-tone audiogram + tympanometry confirms SSHL vs conductive); the audiologist refers to ENT for the steroid prescription same- or next-day. (b) **US** — book ENT same-day directly if you can get an appointment; otherwise audiologist or urgent-care. (c) If neither is available within 24 h, present at A&E / ED — SSHL is a recognised emergency triage category. **The home OTC stack here is an adjunct, not a substitute, and must not delay the audiologist + ENT path.** Cross-reference the sister dossier `[[sshl-hearing-loss]]` for the SSHL home + clinic playbook. *(Plontke 2020 *Lancet*; the country-specific routing reflects the AIIMS Delhi integrative-otolaryngology clinic's real-world escalation ladder; earlier revisions said "see ENT same-day" — corrected 2026-06-07 because the audiologist is the first stop in most non-US health systems)*
>
...
| Formulation | TL;DR (plain English) | Dose | Grade | Citation |
|---|---|---|---|---|
| Khamira Marwareed | Hamdard's flagship pearl-and-rose paste for heart palpitations and ringing. *(Hamdard; Qarabadeen Qadri)* | 5-10 g in the morning | T | *(Hamdard; Qarabadeen Qadri)* |
...
**How to try it.** Self-applied via the McKenna / Marks / Hallam *Living with Tinnitus and Hyperacusis* workbook + audio (free at most libraries). Online programs: Tinnitus Pro Therapy, Beating-the-Blues UK, MoodGYM (Australian National University free CBT). For CBT-I specifically when tinnitus disrupts sleep: Sleepio (UK), CBT-i Coach (free Veterans Affairs app — listed as a tool, not as a US authority). **Grade A** for tinnitus distress reduction (multiple RCTs, Cochrane-supported).
...
> **For you, in plain words.** If your hearing test shows more than 25 decibels of loss at 4-8 kHz, OTC hearing aids restore the missing input — and many models include built-in tinnitus maskers. Often the highest-impact single move. *(Mimi consumer audiogram data; Jabra Enhance / Lexie gain curves)*

**How to try it.** OTC hearing aids: Jabra Enhance, Lexie, Bose SoundControl, Eargo, Sony CRE-C10 — $800-3,000 a pair. Mimi-audiogram-fit. If you want clinical fitting, an audiologist can dial in masker tones precisely (clinic-route, optional).
...
**How to try it.** Home-usable consumer devices: Pulsetto (neck), Truvaga (ear clip), Parasym (ear clip), Xen by Neuvana (ear clip). Apollo Neuro (vibrational, also calms autonomic tone). Nurosym auricular taVNS — 30 min/day. **Do not use** with a pacemaker, history of seizures, or vagal instability. **Grade H** for taVNS specifically for tinnitus (mostly pilot trials; bigger RCTs ongoing). The surgical/implanted VNS (Vivistim, Microtransponder Serenity) is clinic-only and goes in §15.
...
> **For you, in plain words.** Bemer or Healthy Wave mat for 15 min, 3×/week — mechanistic only, with small Eastern-European signal. **Do not use** with a pacemaker, in pregnancy, or with active cancer. *(Bemer mat published protocols)*
...
> **For you, in plain words.** Bhramari (humming-bee breath) is THE tinnitus breath practice. It raises nasal nitric oxide ~15-fold and acoustically "covers" the brain's volume-up. Skip Kapalbhati and Bhastrika. *(S-VYASA Bengaluru Bhramari trials; Karolinska Lundberg nasal nitric-oxide work)*

| Technique | TL;DR (plain English) | Cause | Duration | Time | Citation |
|---|---|---|---|---|---|
| Bhramari (humming bee) | THE tinnitus breath: humming raises nasal nitric oxide 15× and gently "covers" the ringing while calming the vagus. *(S-VYASA; Karolinska Lundberg)* | §2.5 | 10 min primary | 06:30 + 22:00 | *(S-VYASA; Karolinska Lundberg)* |
...
**At week 12 self-check.** Has the MVP + Combo 1 (now 2 months on the full layer) moved your TFI another 5+ points? If YES, hold MVP + Combo 1. If NO, step up to the full §8.1-§8.5 protocol or reassess sub-type (some sub-types — long-standing brain-amplification, pulsatile-vascular — require very different interventions).
...
| Men-Tsee-Khang | Tibetan formulas (Agar-35, Yu-nying-25, Sogdzin-11, Padma-28) from Dharamsala. *(Men-Tsee-Khang formulary; EMA Padma)* | Agar-35, Yu-nying-25, Sogdzin-11, Padma-28 | Men-Tsee-Khang Dharamsala | *(Men-Tsee-Khang; EMA Padma)* |
...
### 13.6 Real-world distributional table (added 2026-06-07 per wave-2 integrative-clinic review)

> **For you, in plain words.** What outcomes look like across **96 patients per quarter** in the AIIMS Delhi integrative-otolaryngology cohort, broken down by sub-type. This is the table the dossier should have been leading with from day 1 — Ravi at 36 points is upper-decile, not median. Use this table to calibrate your own forecast against a real cohort, not a single composite.
...
> **For you, in plain words.** If you have done the home protocol for 6-12 months and your self-score has stopped moving, these are clinic-route options worth discussing with an audiologist or ENT — they are NOT part of the home OTC regime. *(Boedts 2024 Nature Communications Medicine; De Ridder 2014; Conlon 2020 TENT-A1; Conlon 2024 TENT-A2)*
...
| Lenire bimodal | Clinic-only | The strongest single-device randomised trial — but needs a clinic prescription. *(Boedts 2024 Nature Communications Medicine)* | *(Conlon 2024 TENT-A2; Boedts 2024)* |
