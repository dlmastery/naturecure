...
| Saraswatarishta | A fermented Ayurvedic wine taken after meals; calms the mind and supports sleep. **CONSERVATION + BIODIVERSITY CAUTION (wave-14 climate review 2026-06-08):** classical formulation contains *Saussurea costus* (kuth) — CITES Appendix I + IUCN Endangered (Himalayan; international trade restricted). Modern reformulated Saraswatarishta without *S. costus* exists (verify label + supplier UEBT/AYUSH-GMP/Nagoya-compliant); the classical kuth-containing version should be de-emphasised in favour of *S. costus*-free reformulation or substituted by Brahmi + Jatamansi + Mandukaparni. *(Sharangdhara Samhita; Baidyanath, Dabur — verify reformulation; CITES Appendix I; IUCN Red List)* | 15-20 ml twice a day after meals (reformulated only) | T | *(Sharangdhara Samhita; Baidyanath; CITES + IUCN)* |
...
| Jatamansi (*Nardostachys jatamansi*) | Wind-pacifying calming herb — good for tinnitus distress and broken sleep. **CONSERVATION + BIODIVERSITY CAUTION (wave-14 climate review 2026-06-08):** *Nardostachys jatamansi* is **CITES Appendix II + IUCN Critically Endangered** (Himalayan high-altitude; severe over-collection pressure). Wild-harvested supply is **not Nagoya-compliant + biodiversity-critical**. Substitute with cultivated Ashwagandha + Brahmi + Mandukaparni + Shankhpushpi (lower-altitude + non-CITES) unless verified-cultivated Jatamansi from UEBT / Fair-Wild / CCRAS-Sustainable-Cultivation programme. *(Charaka; CCRAS; CITES Appendix II; IUCN CR; Fair-Wild Foundation)* | 1-3 g twice a day **(verified-cultivated only)** | T | *(Charaka; CCRAS; CITES + IUCN + Fair-Wild)* |
...
- **Fractal tones** (**Widex Zen** + Oticon SoundSupport-fractal mode) — built into some hearing aids. **Brand correction 2026-06-12 per wave-8 hearing-tech engineering review:** Zen is a Widex product, NOT ReSound (earlier revisions had this attribution wrong). ReSound has its own tinnitus-relief programme but it is a different algorithm-family (app-coupled hybrid).
...
> **PEM-POSITIVE SAFETY GATE (added 2026-06-07 from wave-12 ME/CFS review).** If your tinnitus is post-COVID, dates from a viral / glandular illness, or you experience **post-exertional malaise (PEM)** — i.e., disproportionate worsening of symptoms 12-72 hours after activity that a non-fatigued person would tolerate — **do NOT follow the weekly periodization below. Follow §7.7.bis instead.** The Mon/Wed/Fri Zone-2 + Tue/Thu strength + monthly cycle below is **structurally similar to the graded-exercise prescription that NICE NG206 (2021, UK) formally removed** after patient-survey-of-harm data showed 50-80% of ME/CFS patients deteriorated on GET-style protocols, with harm that can be permanent. RACP 2022 (Australia), Dutch Gezondheidsraad 2018, and German S3 (in development) followed. **For the ~30-40% of severely-distressed-tinnitus readers who screen PEM-positive (Long COVID, ME/CFS, post-viral fatigue), the protocol below can cause measurable harm. Run the DSQ-PEM-5 screen first.** *(NICE NG206 2021; RACP 2022; Action for ME 2024; Almufarrij & Munro 2021 Long-COVID-tinnitus pooled prevalence 14.8%)*

> **For you, in plain words.** Mon/Wed/Fri easy Zone-2 cardio (you can still talk), Tue/Thu strength, Sat tai chi or qigong, Sun restorative. High-intensity intervals are discouraged in tinnitus-plus-high-BP. **Applies only if you screened PEM-NEGATIVE on the DSQ-PEM-5 above.** *(British Journal of Sports Medicine Zone-2 reviews; ESC tai chi BP review + BHF tai chi guidance)*
...
### 7.7.bis PEM-positive substitution — pacing with heart-rate ceiling (added 2026-06-07)

> **For you, in plain words.** If you screened DSQ-PEM-5-positive (post-COVID / ME/CFS / post-viral fatigue with crash 12-72 h after activity), weekly periodization is **OFF**. Substitute **pacing-with-heart-rate-ceiling**: estimate your anaerobic-threshold floor from resting + AM-orthostatic delta on a smartwatch; set a daily HR ceiling at 60-70% of that floor; **stop all activity when you hit the ceiling, regardless of how you feel** — perceived exertion lags the physiological signal by 6-72 hours in PEM-positive cohorts. No "push-crash-recover" cycles; no deload-week recovery (PEM is not dose-responsive in the linear sense periodization assumes). *(NICE NG206 + RACP 2022 + Charité-CFC + Workwell 2-day-CPET + Stevens 2018)*

**Daily.** Resting HR (lying, on waking) + AM-orthostatic HR (1-min standing) → ΔHR. Daily HR ceiling = resting + (0.6 × ΔHR-equivalent at AT-floor); typical range 90-120 bpm in moderate ME/CFS. Polar / Oura / Garmin / Apple Watch all support a ceiling alarm.

**Activity menu (PEM-positive).** Replace Zone-2 cardio + strength + tai chi periodization with: (a) **flat-ground walking with HR-ceiling alarm** — stop when ceiling hits even if 5 min in; (b) **supine or seated resistance bands** with 30-second rests between every rep — never reps-to-failure; (c) **water-based slow movement** (chest-deep stand-in-water, water-walking) — gravity-offloaded, autonomic-friendly; (d) **restorative yoga / Yoga Nidra / coherent breath** — preserved from §7.6 with the breath-hold caveats below; (e) **rest is an active treatment** — not a failure. Bridges & Pathways (AU Emerge) "spoon theory" energy-envelope rendering is the plain-English version.

**§7.6 PEM-positive adaptations.** (1) Cold-water face splash → lukewarm-to-cool (15-20°C), NOT cold-cold — sudden cold-immersion can trigger POTS-mediated orthostatic crashes; dive-reflex effect is preserved at 15-20°C without the spike. (2) 4-7-8 breath → substitute coherent breath (5.5 in / 5.5 out, no hold) if breath-hold + prolonged-exhale triggers POTS-mediated lightheadedness. (3) Humming + gargling — preserve at conversational volume; not the loud throaty volume Action-for-ME-survey-respondents linked to next-day crashes. (4) Vagus-nerve devices (Nurosym, Sensate, Apollo Neuro, Pulsetto) — preserve; passive + parasympathetic-skewing; well-tolerated in PEM-positive cohorts per Charité-CFC + Vanderbilt registries. (5) Daily 0-10 ringing log — preserve **plus add** a 0-10 daily PEM-load slider so you detect PEM-debt accumulation before the crash.

**Triple-handshake cross-reference.** §0.9 DSQ-PEM-5 screen → §7.7 header gate → §7.7.bis substitution. If you arrived at §7.7 without running §0.9, run it now before reading further. *(WHO PCC 2021/2023; ICMR Long COVID 2022/2024; NICE NG188 + NG206; Charité-CFC 2024; Dysautonomia International + STARS UK)*
...
|---|---|---|---|---|
| Ashwagandha + levothyroxine → TSH drift | ~18% mild; **~4% into subclinical hyperthyroidism** | Hashimoto's + chronic Ashwagandha + dose-stable levothyroxine | Ashwagandha is mildly thyrotropic (Sharma 2018 RCT); compounded with levothyroxine, TSH can suppress | Check TSH at 8 weeks if you are on levothyroxine; drop Ashwagandha if TSH < 0.4 mU/L. **If TSH stays suppressed after stopping Ashwagandha for 8 weeks, request TRAb + fT4 + fT3 — Ashwagandha may have *unmasked* subclinical Graves' rather than caused the drift (wave-12 endocrinology 2026-06-07).** |
| Ashwagandha unmasking subclinical Graves' (no LT4 background) | uncommon but recognised | Untreated subclinical Graves' (suppressed TSH, normal T3/T4, often unaware) + chronic Ashwagandha | Mildly thyrotropic adaptogen tips a borderline-hyperthyroid axis into overt thyrotoxicosis | New palpitations + heat intolerance + tremor + weight loss + new AFib + new pulsatile tinnitus on Ashwagandha → stop, screen TSH + fT4 + fT3 + TRAb; cross-ref §0 pulsatile + wave-8 AFib |
...
> **For you, in plain words.** Tonic water, chronic high-dose aspirin/NSAIDs (**important sub-clause: cardioprotective LOW-DOSE aspirin 75-100 mg/day in post-MI / post-stroke / high-CV-risk readers is a different drug class — do NOT stop it without your prescriber's involvement; the "strictly avoid" framing applies to analgesic-dose ≥325 mg chronic use, not cardioprotective dose**; corrected 2026-06-12 per wave-8 cardiology reviewer), chronic high-dose niacin (Lipoflavonoid not endorsed), chronic Echinacea, melatonin above 3 mg, St John's Wort with antidepressants, anti-cholinergic OTC sleep pills, forceful breath-work in high BP. *(EMA; UK MHRA; AYUSH contraindications; cardioprotective-aspirin sub-clause per ESC + BHF + BIHS post-MI guidance)*
...
- **Diagnosed Ménière's disease** — modifies §6.3 salt restriction to **<1500 mg Na/day (Furstenberg + Bárány 2015 consensus, tighter than the generic <2000 mg)**; clinic-route referral; **betahistine is EU/AU/CA/IN/UK formulary first-line** (NOT US — US-FDA never approved betahistine; doctrine-narrow exception: cited as international formulary pathway, not US-regulator authority); **NB the Cochrane BEMED null finding for betahistine on Ménière**; Bárány 2015 4-question self-screen distinguishes Ménière from VM/BPPV; specialist referral for Meniett low-pressure pulse generator if conservative measures fail. Wave-3 ENT-audiology flagged this on 2026-06-08 + wave-8 vestibular medicine confirmed; now folded into the dossier 2026-06-12.
- **Co-presenting BPPV (vertigo on head movement, ~10-20% co-prevalence)** — **Epley manoeuvre is the single-highest-leverage vestibular intervention (~70-85% first-attempt success per Hilton & Pinder 2014 Cochrane)**; Dix-Hallpike + Epley + Semont + Lempert/BBQ-roll learnable from BTA + RNID + Bárány Society YouTube guides; refer to vestibular specialist if self-administered Epley fails after 2-3 attempts. (Added 2026-06-12 per wave-8 vestibular medicine reviewer.)
- **Vestibular migraine (~25-30% VM-tinnitus comorbidity)** — Bárány-IHS 2012 4-question self-screen (recurrent vestibular symptoms + migraine criteria + ≥5 episodes); Ginkgo + Pycnogenol can act as VM triggers in some users — qualify; CGRP-antagonist landscape (erenumab, fremanezumab, galcanezumab — EMA HMPC + TGA + Health Canada NHP approved; doctrine-narrow exception: cited as international medicines-availability landscape, not US-FDA authority). (Added 2026-06-12 per wave-8 vestibular medicine.)
- **Perilymph fistula (PLF) + superior semicircular canal dehiscence (SSCD)** — Tullio phenomenon (sound-induced vertigo) + Hennebert sign (pressure-induced vertigo) + autophony + pseudo-conductive audiogram + post-trauma / barotrauma / post-stapes-surgery onset; **Bhrāmarī (humming-bee breath) + Sensate cervical vibrotactile are CONTRAINDICATED if PLF/SSCD suspected** (Valsalva + bone-conduction transmit risk); refer to specialist for HRCT temporal bone. (Added 2026-06-12 per wave-8 vestibular medicine.)
- **Heart-failure-with-reduced-ejection-fraction (HFrEF) on combined diuretic + ACE-i + MRA** — **§6.3 low-salt framing INVERTS in this population**: <2000 mg Na/day is correct for inner-ear / Ménière's but **dangerous for HFrEF on combined diuretic stack** (mortality U-curve per ESC HF 2023 + Pasini 2016 + GISSI-HF 2016 — too-low Na worsens outcomes). Discuss sodium target with cardiologist; usually 2000-3000 mg/day is safer for HFrEF. (Added 2026-06-12 per wave-8 cardiology overlap reviewer.)
- **Post-MI / post-stroke + cardiac-rehabilitation phase 1-2** — defer full §7 weekly exercise periodization; substitute the §8.0 Minimum-Viable Protocol only; full protocol layers in at cardiac-rehab phase 3 (~month 4). Discuss with cardiac-rehab team. (Added 2026-06-12 per wave-8 cardiology.)
- **PTSD-active screen (PCL-5 positive)** — defer §5.5 self-applied CBT-T / MBCT-T until trauma-focused therapy (PE / CPT / EMDR / TF-CBT) underway with credentialed clinician — see §12.7 PTSD-comorbid sub-section.
- **PERI-DELIVERY + 0-6-WEEK POSTPARTUM SENTINEL RED-FLAG PATHWAY (added 2026-06-08 per wave-14 lactation-perinatal review).** New-onset tinnitus in the peri-delivery period or first 6 weeks postpartum can be the sentinel sign of a life-threatening emergency — none of the home-protocol layers apply until these are ruled out. Five patterns to recognise: (1) **Pre-eclampsia / eclampsia / HELLP** — tinnitus + new severe headache + visual disturbance + epigastric / RUQ pain + BP ≥140/90 + proteinuria + low platelets / haemolysis / elevated LFTs → maternity-unit emergency assessment same hour. (2) **Post-dural-puncture-headache (PDPH)** after labour epidural / spinal anaesthesia — positional tinnitus + headache that worsens upright + improves recumbent + onset typically 24-72 h post-procedure → anaesthesiology + epidural blood patch consideration. (3) **Sheehan syndrome + postpartum pituitary apoplexy** — peri-delivery tinnitus + sudden severe headache + visual field defect (bitemporal hemianopia) + amenorrhea + failure to lactate + hypotension → endocrinology + neurosurgery emergency. (4) **Cerebral venous sinus thrombosis (CVST) — postpartum-specific risk window 0-6 weeks** — pulsatile tinnitus + headache + focal neuro deficit + seizure → emergency neuroimaging (MRV) same day; anticoagulation pathway. (5) **Postpartum cardiomyopathy + new AFib** — pulsatile tinnitus + dyspnoea + orthopnoea + lower-limb oedema → cardiology emergency assessment; cross-ref wave-8 cardiology + wave-12 endocrinology Graves'-AFib. **None of these are "tinnitus to be managed" — they are "tinnitus as sentinel sign to be triaged at the maternity unit."** Anchors: UKDILAS + bumps UKTIS + Embryotox + Lareb + Mater Mothers + RCOG + RANZCOG + DGGG + FOGSI peri-delivery emergency pathways.
...
> **For you, in plain words (German readers).** Statutory health insurance (GKV) covers HNO consultation + audiogram + hearing aids (Festbetrag €784.94 per ear as of 2024) + § 28-32 SGB V Psychotherapie + § 40 SGB V **combined cardiology + tinnitus + psychosomatic Reha** at specialised clinics (Bad Arolsen, Bad Salzhausen, Bad Driburg, Bad Bellingen, Klinik Wespien — these are **NOT tinnitus-only programs**; they are integrated cardio-psychosomatic Reha-Kliniken that include tinnitus management as part of the wider package — corrected 2026-06-12 per wave-8 cardiology reviewer who caught the prior tinnitus-only framing). Heilpraktiker-Wahltarif Krankenkassen (AOK Naturheilkunde, BKK ProVita, IKK classic Naturmedizin, SBK Komfort, hkk) cover Tebonin + integrative-medicine consultations. Tinnitus-Liga Bundesverband + Deutsche Tinnitus-Stiftung Charité offer peer-support resources.
